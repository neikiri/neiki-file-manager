...
### Added
- Configurable folder icons (`folderIcons`), enabling developers to assign custom icons (SVG markup, image URLs, or text/emojis) to specific folders via configuration or item property (`icon`).
