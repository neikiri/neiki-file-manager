<p align="center">
  <img src="assets/img/logo.svg" alt="Neiki's File Manager" style="height: 90px; width: auto;">
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-1.3.0-2563EB?style=for-the-badge&logo=semantic-release&logoColor=white&labelColor=000F15&logoWidth=20" alt="Version">
</p>
...
<p align="center">
  ⭐ Enjoying Neiki's File Manager? Give it a Star and Fork the repository! ❤️<br>
...
<p align="center">
  <a href="https://github.com/neikiri/neiki-file-manager/fork">
...
```html
<script src="https://cdn.neikiri.dev/neiki-file-manager/1.3.0/neiki-file-manager.min.js"></script>
```
...
<!-- Or pinned -->
<link rel="stylesheet" href="https://cdn.neikiri.dev/neiki-file-manager/1.3.0/neiki-file-manager.css">
<script src="https://cdn.neikiri.dev/neiki-file-manager/1.3.0/neiki-file-manager.js"></script>
```
...
<!-- Pinned -->
<script src="https://cdn.jsdelivr.net/npm/neiki-file-manager@1.3.0/dist/neiki-file-manager.min.js"></script>
```

**Alternative CDN — unpkg**

```html
<script src="https://unpkg.com/neiki-file-manager@1.3.0/dist/neiki-file-manager.min.js"></script>
```
...
| `icon` | string | Optional custom icon for folders (SVG markup, image URL, or emoji/text). |
...
fm.getView();
fm.setConfig({ theme: 'dark', sortBy: 'size', sortDir: 'desc', folderIcons: { 'photos': '🖼️' }, folderOrder: ['Photos', 'Documents'] });
fm.getConfig();
